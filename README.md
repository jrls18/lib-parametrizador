...
### Gradle
```
implementation group: 'br.com.group.developer.corporation', name: 'lib-parametrizador', version: '5.0.0'
```

### Gradle Short
```
implementation 'br.com.group.developer.corporation:lib-parametrizador:5.0.0'
```
